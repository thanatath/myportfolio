    ...
    render() {
      return (
          <div>
              ...
              <a href='#me'><FontAwesomeIcon className='px-1 hover:scale-125 duration-300 z-40 mt-3 h-[25px]' icon={solid('address-card')} /></a>
              <a href='#education'><FontAwesomeIcon className='px-1 hover:scale-125 duration-300 z-40 mt-3 h-[25px]' icon={solid('graduation-cap')} /></a>
