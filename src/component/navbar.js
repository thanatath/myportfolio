    ...
    render() {
      return (
          <div>
              ...
              <a href='#work_ex'><FontAwesomeIcon className='px-1 z-40 mt-3 h-[25px]' icon={solid('briefcase')} /></a>
              <a href='#myskill'><FontAwesomeIcon className='px-1 z-40 mt-3 h-[25px]' icon={solid('utensils')} /></a>
              <a href='#work'><FontAwesomeIcon className='px-1 md:ml-1 z-40 mt-3 h-[25px]' icon={solid('puzzle-piece')} /></a>
